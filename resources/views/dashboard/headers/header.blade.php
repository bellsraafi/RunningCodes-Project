        ...
        <div class="topmenu-outer">
        	<div class="top-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if(!Auth::guest())
                        <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                            <span class="user-name" style="text-transform: capitalize;">{{ Auth::user()->trainee->first_name .' '. Auth::user()->trainee->last_name }}<i class="fa fa-angle-down"></i></span>
                            <img class="img-circle avatar" src="/images/profile_pics/{{Auth::user()->trainee->profile_pic }}" width="40" height="40" alt="">
                        </a>
